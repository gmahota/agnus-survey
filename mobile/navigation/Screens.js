...
import SurveyCompleted from '../screens/SurveyCompletedScreen';
...
function SurveyCompletedStack(props) {
  return (
    <Stack.Navigator initialRouteName="SurveyCompleted" mode="card" headerMode="screen">
      <Stack.Screen
        name="SurveyCompleted"
        component={SurveyCompletedScreen}
        options={{
...
function AppStack(props) {
  return (
    ...
    >
      ...
      <Drawer.Screen name="SurveyCompleted" component={SurveyCompletedStack} />
    </Drawer.Navigator>
  );
}
